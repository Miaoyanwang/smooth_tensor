...
#' @references Anonymous authors. Smooth tensor estimation with unknown permutations. 2021.
#' @examples
#'
...
#' @references Xu, J. Rates of convergence of spectral methods for graphon estimation. International Conference on Machine Learning, 2018. \cr Anonymous authors. Smooth tensor estimation with unknown permutations. 2021.
#' @examples
#'
#' # Generate the noisy observation from smooth tensor and permutation
#' d = 20
...
#' @references Gao, C., Y. Lu, and H. H. Zhou. Rate-optimal graphon estimation. The Annals of Statistics, 2015. \cr Balasubramanian, K. Nonparametric modeling of higher-order interactions via hypergraphons. Journal of Machine Learning Research, 2021. \cr Han, R., Y. Luo, M. Wang, and A. R. Zhang. Exact clustering in tensor block model: Statistical optimality and computational limit. arXiv:2012.09996, 2020.
#' @examples
#'
#' # Generate the noisy observation from smooth tensor and permutation
#' d = 20
